...
def calculate_accuracy(predictions, ground_truths):
    ...
    return accuracy
write_jsonl( os.path.join(result_dir, "Commonsense_QA.jsonl"),data_entries, 'w')
...
print(f"F1      : {f1['f1']:.4f}")
results = {"model":"deepseek-r1","dataset":"Commonsense_QA","num_samples":num_samples,"accuracy": accuracy,"F1":f1['f1']}
